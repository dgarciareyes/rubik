    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ url('/companias') }}">Compañias</a></div>
                <div class="breadcrumb-item active">Cambiar datos de la Compañia</div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4>Cambiar datos de la Compañia</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ url('/companias/' . $compania->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="rut" type="text" id="rut"
                                            ...
                                            value="{{ old('rut', $compania->rut) }}" maxlength="8" onkeyup="rutdv(this.value);"
                                        ...
                                        <input name="dv" type="text"
                                            ...
                                            value="{{ old('dv', $compania->dv) }}" id="dv" maxlength="1"
                                            ...
                                            <div class="card col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="image" type="file" id="image" accept="image/*"
                                                        class="form-control" value="{{ old('image', $compania->image) }}"
                                        ...
                                        <div class="row">
                                            <div class="card col-12">
                                                <img id="imagenSeleccionada"
                                                    src="{{ asset('/img/companias') }}/{{ $compania->image }}"
