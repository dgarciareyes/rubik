    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">Agregar datos del Ramo</div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4>Agregar datos del Ramo</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ url('/ramos') }}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                                @csrf
